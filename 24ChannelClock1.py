#!/usr/bin/env python3
"""
Class 11 — 24 Independent Grating Clocks + Probability Landscape of Holes
Each channel is its own clock face; probability of unmarked index is computed live.
"""
...
def animate(frame):
    ...
    # Amplitude map and probability of unmarked
    ax_amp.clear()
    current_amp = amp[:300]
    ...
    prob_unmarked = 1.0 - current_amp / 24.0
    ax_prob.clear()
