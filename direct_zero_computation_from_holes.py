...
# ====================== CONFIG ======================
max_m = 1000            # larger = more accurate candidates
t_start, t_end, step = 10, 100, 0.01
known_zeros = [14.134725, 21.022039, 25.010857, 30.424876, 32.935062, 37.586178, 40.918719, 43.327073, 48.0051508811, 49.773832477, 52.970321477, 56.44624769]
# ===================================================
...
plt.title('Direct Computation of Candidate Zeta Zeros from Algebraic Ideal coprime-to-90')
